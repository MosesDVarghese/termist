...
use termist_terminal::term::TermMode;
...
pub enum Action {
    ...
    /// Hide the Termist window.
    Hide,

    /// Hide all windows other than Termist on macOS.
    HideOtherApplications,

    /// Minimize the Termist window.
    Minimize,
    ...
    /// Spawn a new instance of Termist.
    SpawnNewInstance,
