...
use termist_terminal::term::Config as TermConfig;
use termist_terminal::tty::{Options as PtyOptions, Shell};
use log::{error, warn};
...
use termist_config_derive::{ConfigDeserialize, SerdeReplace};
use termist_terminal::term::search::RegexSearch;
...
pub struct UiConfig {
    ...
    /// Config for the termist_terminal itself.
