...
use termist_terminal::index::Point;
...
/// This should match the definition of IDI_ICON from `termist.rc`.
#[cfg(windows)]
...
///
/// Wraps the underlying windowing library to provide a stable API in Termist.
pub struct Window {
