...
use termist_terminal::grid::{BidirectionalIterator, Dimensions};
use termist_terminal::index::{Boundary, Column, Direction, Line, Point};
use termist_terminal::term::cell::Hyperlink;
use termist_terminal::term::search::{Match, RegexIter, RegexSearch};
...
#[cfg(test)]
mod tests {
    use termist_terminal::index::{Column, Line};
    use termist_terminal::term::test::mock_term;
    use termist_terminal::vte::ansi::Handler;
