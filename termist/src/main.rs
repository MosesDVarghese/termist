//! Termist - The GPU Enhanced Terminal.
...
/// Temporary files stored for Termist.
///
...
/// Run main Termist entrypoint.
///
/// Creates a window, the terminal state, PTY, I/O event loop, input processor,
/// config change monitor, and runs the main display loop.
fn termist(mut options: Options) -> Result<(), Box<dyn Error>> {
